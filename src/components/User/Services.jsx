			...
			<div className="container">
				<div className="row align-items-center">
					...
					<div className="col-md-6 text-center mb-4 mb-md-0">
						<img src={ServiceImg} alt="Car Service" className="img-fluid" style={{ maxWidth: '400px' }} />
					</div>

					{/* Content Section */}
					<div className="col-md-6">
						<h2 className="fs-2 fw-bold mb-3">Best Car Rental for any kind of trip in (Lokasimu)!</h2>
						...
						<ul className="list-unstyled">
							<li className="d-flex align-items-center mb-2">
								<IoCheckmarkCircleSharp className="text-success me-2" size={24} />
