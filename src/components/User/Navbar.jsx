					...
					<div className="offcanvas-body">
						<ul className="navbar-nav ms-auto">
							...
							<li className="nav-item">
								<button onClick={() => scrollToSection('ourservices')} className="nav-link btn btn-link">
									Our Services
								</button>
							</li>
							<li className="nav-item">
								<button onClick={() => scrollToSection('whyus')} className="nav-link btn btn-link">
									Why Us
								</button>
							</li>
							<li className="nav-item">
								<button onClick={() => scrollToSection('testimonial')} className="nav-link btn btn-link">
									Testimonial
								</button>
							</li>
							<li className="nav-item">
								<button onClick={() => scrollToSection('faq')} className="nav-link btn btn-link">
									FAQ
								</button>
							</li>
